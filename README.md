...
Loading this data into Senzing requires additional features and configurations. These are contained in the [sayari-config-updates.g2c](sayari-config-updates.g2c) file.

This mapper also uses a conversion table to map Sayari codes into Senzing codes.  These are contained in the [sayari-codes.csv](sayari-codes.csv) file.
...
- [sayari-config-updates.g2c](sayari-config-updates.g2c)
- [sayari-codes.csv](sayari-codes.csv)
